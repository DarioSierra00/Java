...
import com.edu.mockEuro.model.CombinacionException;
import com.edu.mockEuro.model.Historial;
import com.edu.mockEuro.model.HistorialException;
	...
	public static void main(String[] args) {
		...
		try {
			...
			try {
				...
				System.out.println(h1.listarSorteosDesdeFecha(LocalDate.of(2022, 3, 2)));
