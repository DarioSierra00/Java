...
public class Serie {
	...
	//Hemos optado por una estructura tipo lista porque las series tienen una lista de temporadas que a su vez, las temporadas tienen una lista de capitulos
	...
	public void annadirTemporada(String nombreTemporada) throws SerieException {
		if(this.temporadas.indexOf(nombreTemporada)!=-1) {
	...
	public String listadoTemporadasPorNumeroDeCapitulos() {
		StringBuilder sb = new StringBuilder();
		Collections.sort(this.temporadas, new ComparatorPorNumCapitulos());
