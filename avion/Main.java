	...
	public static void main(String[] args) {
		...
		if (opcion==1 || opcion==2) {
			if (opcion==1) {
				...
				av = new Avion(identificador,capacidad);
			}else if (opcion==2) {
				System.out.println("Introduce el identificador del avion: ");
				identificador = sc.nextLine();
				System.out.println("Introduce la capacidad del avión: ");
			...
			if (opcion2.equals("a")) {
				...
				System.out.println("Nombre de la compañia que ha comprado el avión: ");
				compannia = (sc.nextLine());
			}else if (opcion2.equals("f")) {
				System.out.println("Avion con id " +identificador + " de la compañia "+ compannia + " ha realizado "+ a.getNumVuelos() + " vuelos, con un total de "+ numKm + " km y una media de "+ a.getMediaKm() + " km por vuelo.");
			}
